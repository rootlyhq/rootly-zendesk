...
export default function IncidentsListRecent () {
  ...
  return (
    <Grid gutters={false}>
      ...
      <Row>
        <Col>
          {totalPages > 0 && <OffsetPagination totalPages={totalPages} pagePadding={0} currentPage={currentPage} onChange={(page) => dispatch(paginateIncidents(page))} style={{ margin: '.5em 0' }} />}
        </Col>
      </Row>
    </Grid>
  )
